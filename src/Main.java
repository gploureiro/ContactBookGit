...
public class Main {
    ...
    public static final String HAVE_DIF = "All contacts have different phone numbers.";
    public static final String NO_DIF = "There are contacts that share phone numbers.";
    ...
    private static void getNumber(Scanner in, ContactBook cBook) {
        ...
        if (cBook.hasNumber(number)) {
            System.out.println(cBook.getContactFromNumber(number));
        }
    ...
    private static void checkEqualPhones(ContactBook cBook) {
        if (cBook.checkEqualPhones()) {
            System.out.println(HAVE_DIF);
        } else {
            System.out.println(NO_DIF);
        }
    }
}
